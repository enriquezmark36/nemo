...
static gint
get_icon_view_icon_width_key (void)
{
    return g_settings_get_enum (nemo_icon_view_preferences,
...
nemo_icon_view_begin_loading (NemoView *view)
{
	...
	nemo_icon_container_set_icon_width (get_icon_container (icon_view),
                                            get_icon_view_icon_width_key ());
...
nemo_icon_view_reset_to_defaults (NemoView *view)
{
	...
	nemo_icon_container_set_icon_width (icon_container,
                           get_icon_view_icon_width_key ());
...
static void
icon_view_icon_width_callback (gpointer callback_data)
{
	NemoIconView *icon_view;
	NemoIconContainer *icon_container;
...
nemo_icon_view_init (NemoIconView *icon_view)
{
    ...
    g_signal_connect_swapped (nemo_icon_view_preferences,
                 ...
                 icon_view);
	g_signal_connect_swapped (nemo_icon_view_preferences,
				  "changed::" NEMO_PREFERENCES_ICON_VIEW_ICON_WIDTH,
				  G_CALLBACK (icon_view_icon_width_callback),
				  icon_view);
